...
L["Setup Categories"] = "Настроить категории"
...
L["Targets"] = "Цели"
L["Random dungeon finder queue status frame."] = "Окно состояния очереди Поиска случайных подземелий."
L["Queue Time"] = "Время ожидания"
L["RDFQueueTracker"] = "ОтслеживаниеОчередиRDF"
L["Abbreviate Numbers"] = "Сократить числа"
L["DEFAULTS"] = "ПО УМОЛЧАНИЮ"
L["INTERRUPT"] = "ПРЕРВАТЬ"
L["CONTROL"] = "КОНТРОЛЬ"
L["Copy List"] = "Копировать список"
L["DepthOfField"] = "Глубина резкости"
L["Fades nameplates based on distance to screen center and cursor."] =
	"Затухание индикаторов здоровья на основе расстояния до центра экрана и курсора."
L["Disable in Combat"] = "Отключить в бою"
L["Y Axis Pivot"] = "Точка оси Y"
L["Most opaque spot relative to screen center."] = "Самая непрозрачная точка относительно центра экрана."
L["Min Opacity"] = "Минимальная прозрачность"
L["Falloff Rate"] = "Скорость затухания"
L["Mouse Falloff Rate"] = "Скорость затухания от мыши"
L["Base multiplier."] = "Базовый множитель."
L["Effect Curve"] = "Кривая эффекта"
L["Mouse Effect Curve"] = "Кривая эффекта мыши"
L["Higher values result in steeper falloff."] = "Более высокие значения приводят к более резкому затуханию."
L["Enable Mouse"] = "Включить мышь"
L["Also calculate cursor proximity."] = "Также учитывать близость курсора."
L["Ignore Styled"] = "Игнорировать стилизованные"
L["Ignore Target"] = "Игнорировать цель"
L["Spells outside the selected whitelist filters will not be displayed."] =
	"Заклинания, не входящие в выбранные фильтры белого списка, не будут отображаться."
L["Enables tooltips to display which set an item belongs to."] = "Включает подсказки, отображающие, к какому набору принадлежит предмет."
L["TierText"] = "Текст уровня"
...
L["Use Default Handling"] = "Использовать обработку по умолчанию"
L["Show Group Members"] = "Показать членов группы"
L["Hide Group Members"] = "Скрыть членов группы"
L["Select 'Enemy Player' to configure."] = "Выберите 'Вражеский игрок' для настройки."
L["Capture Bar"] = "Панель захвата"
L["Capture Bar Mover"] = "Перемещение панели захвата"
L["Capture Bar Height"] = "Высота панели захвата"
L["Also might fix capture bar related issues like progress marker not showing."] =
	"Также может исправить проблемы с панелью захвата, такие как отсутствие индикатора прогресса."
L["Max Length"] = "Максимальная длина"
L["Channel button visibility."] = "Видимость кнопки канала."
L["Copy button visibility."] = "Видимость кнопки копирования."
L["Mouseover: Channel Button"] = "Наведение: Кнопка канала"
L["Mouseover: Copy Button"] = "Наведение: Кнопка копирования"
