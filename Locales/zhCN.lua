...
L["Targets"] = "目标"
L["Random dungeon finder queue status frame."] = "随机地下城查找器队列状态框体。"
L["Queue Time"] = "排队时间"
L["RDFQueueTracker"] = "随机地下城队列追踪器"
...
L["Copy List"] = "复制列表"
L["DepthOfField"] = "景深"
L["Fades nameplates based on distance to screen center and cursor."] = "根据到屏幕中心和光标的距离淡化姓名板。"
L["Disable in Combat"] = "战斗中禁用"
L["Y Axis Pivot"] = "Y轴枢轴"
L["Most opaque spot relative to screen center."] = "相对于屏幕中心最不透明的点。"
L["Min Opacity"] = "最小不透明度"
L["Falloff Rate"] = "衰减率"
L["Mouse Falloff Rate"] = "鼠标衰减率"
L["Base multiplier."] = "基础乘数。"
L["Effect Curve"] = "效果曲线"
L["Mouse Effect Curve"] = "鼠标效果曲线"
L["Higher values result in steeper falloff."] = "较高的值会导致更陡峭的衰减。"
L["Enable Mouse"] = "启用鼠标"
L["Also calculate cursor proximity."] = "同时计算光标距离。"
L["Ignore Styled"] = "忽略已设样式"
L["Ignore Target"] = "忽略目标"
L["Spells outside the selected whitelist filters will not be displayed."] =
	"选定白名单过滤器外的法术将不会显示。"
L["Enables tooltips to display which set an item belongs to."] = "启用工具提示以显示物品属于哪个套装。"
L["TierText"] = "等级文本"
L["Select Item"] = "选择物品"
...
L["Capture Bar"] = "占领条"
L["Capture Bar Mover"] = "移动占领条"
L["Capture Bar Height"] = "占领条高度"
L["Also might fix capture bar related issues like progress marker not showing."] =
	"也可能修复占领条相关问题，例如进度标记未显示。"
L["Max Length"] = "最大长度"
L["Channel button visibility."] = "频道按钮的可见性。"
L["Copy button visibility."] = "复制按钮的可见性。"
L["Mouseover: Channel Button"] = "鼠标悬停: 频道按钮"
