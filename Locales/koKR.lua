...
L["Setup Categories"] = "카테고리 설정"
L["Disable Cooldown"] = "재사용 대기시간 비활성화"
...
L["Targets"] = "대상"
L["Random dungeon finder queue status frame."] = "무작위 던전 찾기 대기열 상태창."
L["Queue Time"] = "대기 시간"
L["RDFQueueTracker"] = "RDF대기열추적기"
L["Abbreviate Numbers"] = "숫자 축약"
L["DEFAULTS"] = "기본값"
L["INTERRUPT"] = "중단"
L["CONTROL"] = "제어"
L["Copy List"] = "목록 복사"
L["DepthOfField"] = "심도"
L["Fades nameplates based on distance to screen center and cursor."] = "화면 중앙과 커서까지의 거리에 따라 이름표를 페이드합니다."
L["Disable in Combat"] = "전투 중 비활성화"
L["Y Axis Pivot"] = "Y축 피벗"
L["Most opaque spot relative to screen center."] = "화면 중앙 기준 가장 불투명한 지점."
L["Min Opacity"] = "최소 불투명도"
L["Falloff Rate"] = "감쇠율"
L["Mouse Falloff Rate"] = "마우스 감쇠율"
L["Base multiplier."] = "기본 승수."
L["Effect Curve"] = "효과 곡선"
L["Mouse Effect Curve"] = "마우스 효과 곡선"
L["Higher values result in steeper falloff."] = "높은 값일수록 더 가파른 감쇠가 됩니다."
L["Enable Mouse"] = "마우스 활성화"
L["Also calculate cursor proximity."] = "커서 근접도도 계산합니다."
L["Ignore Styled"] = "스타일된 무시"
L["Ignore Target"] = "대상 무시"
L["Spells outside the selected whitelist filters will not be displayed."] =
	"선택한 허용 목록 필터 외의 주문은 표시되지 않습니다."
L["Enables tooltips to display which set an item belongs to."] = "아이템이 속한 세트를 표시하는 툴팁을 활성화합니다."
L["TierText"] = "티어 텍스트"
...
L["Use Default Handling"] = "기본 처리 사용"
L["Show Group Members"] = "그룹원 표시"
L["Hide Group Members"] = "그룹원 숨기기"
L["Select 'Enemy Player' to configure."] = "'적 플레이어'를 선택하여 설정하세요."
L["Capture Bar"] = "점령 바"
L["Capture Bar Mover"] = "점령 바 이동기"
L["Capture Bar Height"] = "점령 바 높이"
